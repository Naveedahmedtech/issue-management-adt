...
const InputField: React.FC<IInputFieldProps & { labelColor?: string }> = ({
  label,
  leftIcon,
  readonly = false,
  labelColor = 'text-textDark', // default
  ...props
}) => {
      ...
      <div className="mt-1 relative">
        ...
        <input
          className={`block w-full ${
            leftIcon ? 'pl-10' : 'pl-2'
          } pr-3 sm:text-sm outline-none border-background text-textDark
            ${!readonly ? 'focus:border-primary' : 'focus:outline-none border-none'}
