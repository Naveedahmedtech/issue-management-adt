...
const STATUS_COLORS: Record<string, string> = {
  ...
  ARCHIVE: "bg-backgroundShade1 text-text",
};

const DEFAULT_OPTIONS: StatusOption[] = [
  { label: "ACTIVE", value: PROJECT_STATUS.ACTIVE?.toUpperCase(), colorClass: "bg-todo" },
  { label: "COMPLETED", value: PROJECT_STATUS.COMPLETED?.toUpperCase(), colorClass: "bg-success" },
  { label: "ARCHIVE", value: PROJECT_STATUS.ARCHIVE?.toUpperCase(), colorClass: "bg-backgroundShade1" },
];
...
const ProjectStatusDropDown: React.FC<StatusDropdownProps> = ({
  value,
  onChange,
  disabled,
  options,
