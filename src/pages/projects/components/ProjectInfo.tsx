        ...
        <div className="mt-4 flex gap-2 items-end">
          <div className="flex-1">
            <PaginatedDropdown
              ...
              placeholder={selectedUser ? selectedUser.label : "Select a user"}
            />
          </div>
          <button
        ...
        <div className="mt-4">
          ...
          <div className="flex flex-wrap gap-2">
            {selectedUsers.map((user) => (
              <div key={user.value} className="flex items-center px-3 py-1 rounded-full text-sm border border-text transition">
                {user.label}
                <FiX
